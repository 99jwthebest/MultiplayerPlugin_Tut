...
protected:
	...
	// These don't need to be called outside of this class, and so are only here to internal to the subsystem.
	//
...
private:
	...
	// We'll bind our MultiplayerSessionsSubsystem functions to these.
	//
